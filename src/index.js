...
class Header {
   ...
   *
   * @param {ToolboxItem} toolboxItem - toolbox item to check
   * @returns {boolean}
   */
  isToolboxItemActive(toolboxItem) {
    if (!toolboxItem.config) {
      return false;
    }

    return this.currentLevel.number === toolboxItem.config.defaultLevel;
  }
}
